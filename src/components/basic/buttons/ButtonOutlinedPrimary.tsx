...
interface ButtonOutlinedPrimaryProps {
...
const ButtonWrapper = styled.button<{
  ...
  &:hover {
    background-color: ${(props) =>
      props.$disabled ? theme.colors.white : theme.colors.purple[50]};
  }

  &:active {
    background-color: ${(props) =>
      props.$disabled ? theme.colors.white : theme.colors.purple[100]};
  }
`;
...
const ButtonOutlinedPrimary: React.FC<ButtonOutlinedPrimaryProps> = ({
  leftIcon,
  rightIcon,
  label,
  onClick,
